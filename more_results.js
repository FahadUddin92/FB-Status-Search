function getmoreResults(u) {
																		// print that we are in
	$.ajax({
	    dataType: "jsonp", 
	    url: u,
...
/*
     FILE ARCHIVED ON 07:44:30 Apr 24, 2013 AND RETRIEVED FROM THE
...
/*
playback timings (ms):
  LoadShardBlock: 49.487 (3)
  esindex: 0.007
  captures_list: 86.047
  CDXLines.iter: 15.923 (3)
  PetaboxLoader3.datanode: 46.725 (4)
  exclusion.robots: 0.249
  exclusion.robots.policy: 0.236
  RedisCDXSource: 16.697
  PetaboxLoader3.resolve: 22.622
  load_resource: 85.148
*/